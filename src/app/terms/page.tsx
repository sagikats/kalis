...
export const metadata: Metadata = {
	title: 'תנאי שימוש והגבלת אחריות | מתקבלים (mitkablim.co.il)',
	description: 'תנאי השימוש, כתב הוויתור והגבלת האחריות של פלטפורמת מתקבלים (mitkablim.co.il) לחישוב סכם ותכנון קבלה אקדמית.',
};
			...
			<div className="max-w-4xl mx-auto">
					...
					<div className="flex items-start gap-3.5">
						...
						<div>
							...
							<p className="text-xs sm:text-sm text-[#78350F] leading-relaxed">
								פלטפורמת <strong>מתקבלים (mitkablim.co.il)</strong> הינה מיזם טכנולוגי עצמאי שנועד לשמש ככלי עזר והדמיה אקדמית בלבד. האתר, מחשבוניו ומנוע ההמלצות אינם פועלים מטעם המועצה להשכלה גבוהה (מל״ג), משרד החינוך, המרכז הארצי לבחינות ולהערכה (מאלו״ו), או מי ממוסדות הלימוד האקדמיים בישראל. <strong>הסמכות הבלעדית והקובעת לקבלה או דחייה לכל תוכנית לימודים הינה של ועדת הקבלה של המוסד האקדמי בלבד.</strong>
							</p>
						</div>
					</div>
				</div>
				...
				<div className="space-y-8 text-sm leading-relaxed text-[#44423D]">
					...
					<section className="bg-white p-6 sm:p-8 rounded-2xl border border-[#E5DFD4] shadow-xs">
						...
						<p className="mb-3">
							ברוכים הבאים לאתר <strong>מתקבלים (mitkablim.co.il)</strong> (להלן: &quot;האתר&quot; או &quot;השירות&quot;). השימוש באתר, לרבות במחשבוני הסכם, בשאלון האישי, במנוע האופטימיזציה, במאגרי המידע ובתוכניות הלימוד, כפוף להוראות תנאי שימוש אלה (להלן: &quot;תנאי השימוש&quot;) ולמדיניות הפרטיות.
						</p>
						<p>
					...
					<section className="bg-white p-6 sm:p-8 rounded-2xl border border-[#E5DFD4] shadow-xs">
						...
						<p className="mb-3">
							כל זכויות הקניין הרוחני באתר, לרבות באלגוריתמי האופטימיזציה, במבנה הנתונים, בקוד המקור, בעיצוב הגרפי, בממשק המשתמש (UI/UX), בסמליל (לוגו) ובסימני המסחר שייכות באופן בלעדי למפעילי מתקבלים (mitkablim.co.il).
						</p>
						<p>
