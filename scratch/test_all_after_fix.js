// Run multiCalculator with the user's exact subjects
...
const tauResult = calculateOptimalTauBagrut(subjects);
console.log('TAU Average:', tauResult.average);
console.log('TAU Optimal Units:', tauResult.optimalUnits);
console.log('TAU Dropped:', tauResult.droppedSubjects.map(s => s.name));
