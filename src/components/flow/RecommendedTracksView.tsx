	...
	return (
		<div className="space-y-8 dir-rtl text-right">
			...
			<div className="bg-gradient-to-r from-slate-900 via-indigo-950/40 to-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
				...
				<div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
					<div className="space-y-2">
						...
						<h2 className="text-2xl sm:text-3xl font-black text-white">
							תוכנית סגירת הפער האישית שלך
						</h2>
						<p className="text-xs sm:text-sm text-slate-300 max-w-2xl">
							בהתאם לשאלון ההעדפות ורמת הבסיס שלך, האלגוריתם הפיק 3 מסלולים ריאליים ומבוססי סטטיסטיקה.
							כל מסלול מאזן בצורה שונה בין זמן, מאמץ והסתברות הצלחה.
						</p>
					</div>
				...
				<div className="mt-6 pt-4 border-t border-slate-800/80 flex items-center gap-3 text-xs text-slate-300 bg-slate-950/40 rounded-2xl p-3 border border-slate-800">
